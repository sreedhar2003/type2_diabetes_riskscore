              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Have you ever had a high blood glucose (sugar) reading?",
                      style: GoogleFonts.roboto(
                        color: AppColors.black,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400,
                    ...
                    SizedBox(height: 10),
                    Text(
                      "This includes any diagnosis of pre-diabetes, gestational diabetes, or high blood sugar during a check-up.",
                      maxLines: 3,
                      style: GoogleFonts.roboto(
                        color: AppColors.grey,
                        fontSize: 12.sp,
